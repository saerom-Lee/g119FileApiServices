...
public class ApacheZipUtils {
    ...
    public boolean unzip(File zippedFile) throws IOException {
       return unzip(zippedFile, Charset.defaultCharset().name());
    }
     
    public boolean unzip(File zippedFile, String charsetName ) throws IOException {
    	return unzip(zippedFile, zippedFile.getParentFile(), charsetName);
    }
    ...
    public boolean unzip(File zippedFile, File destDir, String charsetName)
    throws IOException {
    ...
    public boolean unzip( InputStream is, File destDir, String charsetName)
    throws IOException {
		boolean isChk = false;
